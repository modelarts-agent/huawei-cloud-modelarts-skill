...
def ma_old_inference_service_update_property(
    access,
    ...
    更新服务属性
        ...
        Returns:
            更新结果
        示例:
            >>> from infer1.0_module import ma_old_inference_service_update_property
            >>> result = ma_old_inference_service_update_property('service-xxx-xxx-xxx')
            >>> if result['success']:
            ...     print("更新成功")
    """
    if not service_id:
...
__all__ = ['ma_old_inference_service_update_property']
