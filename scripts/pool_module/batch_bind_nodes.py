...
def batch_bind_nodes(access, pool_name: str, node_names: List[str]) -> Dict[str, Any]:
    """
    批量绑定资源池节点
    ...
    result = access_api_call(
        access,
        "POST",
        "/v2/{project_id}/pools/{pool_name}/nodes/batch-bind",
