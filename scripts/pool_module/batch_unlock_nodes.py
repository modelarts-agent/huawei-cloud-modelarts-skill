...
def batch_unlock_nodes(access, pool_name: str, node_names: List[str]) -> Dict[str, Any]:
    """
    批量解锁资源池节点
    ...
    result = access_api_call(
        access,
        "POST",
        "/v2/{project_id}/pools/{pool_name}/nodes/batch-unlock",
